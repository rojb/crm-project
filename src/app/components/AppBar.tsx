...
export const AppBar = () => {
    return (
        <div className='flex w-full justify-between shadow-md px-3 text-center'>
            <div className="">
            ...
            <div className="flex items-center space-x-4">
                <div className="flex items-center bg-background rounded-2xl w-96 px-4 shadow-sm">
                ...
                {/* <div className="cursor-pointer text-main font-medium">Filtros</div> */}
            </div>
        </div>
    )
}
