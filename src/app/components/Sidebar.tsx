...
export const Sidebar = () => {
    return (
        <div id="menu" className="bg-white min-h-screen z-10 text-slate-300 w-75 left-0 h-screen overflow-y-scroll">
            ...
            <div id="nav" className="w-full px-6">
                <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 bg-blue-800 hover:bg-white/5 transition ease-linear duration-150">
                    ...
                    <div className="flex flex-col">
                        <span className="text-lg font-bold leading-5 text-white">Embudos</span>
